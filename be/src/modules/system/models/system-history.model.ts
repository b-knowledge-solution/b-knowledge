/**
 * @fileoverview System history model encapsulating all cross-table analytics queries
 * for the system history module. Handles chat, search, and agent run history queries
 * with feedback aggregation, full-text search, and pagination.
 * @module modules/system/models/system-history
 */
...
/**
 * @description Model for system history analytics queries across multiple tables.
 ...
 */
export class SystemHistoryModel {
