/**
 * @fileoverview Zod validation schemas for the Knowledge Base module.
...
/** @description Validates knowledge base ID path parameter */
export const knowledgeBaseIdParamSchema = z.object({
  id: z.string().min(1, 'Knowledge Base ID is required'),
})

/** @description Validates knowledge base ID and permission ID path parameters */
export const permissionParamSchema = z.object({
  id: z.string().min(1, 'Knowledge Base ID is required'),
  permId: z.string().min(1, 'Permission ID is required'),
})

/** @description Validates knowledge base ID and dataset UUID path parameters */
export const knowledgeBaseDatasetParamSchema = z.object({
  id: z.string().min(1, 'Knowledge Base ID is required'),
  datasetId: hexIdWith('Invalid dataset UUID'),
})

/** @description Validates knowledge base ID and category ID path parameters */
export const categoryParamSchema = z.object({
  id: z.string().min(1, 'Knowledge Base ID is required'),
  catId: z.string().min(1, 'Category ID is required'),
})

/** @description Validates knowledge base, category, and version ID path parameters */
...
/** @description Validates knowledge base ID and chat ID path parameters */
export const chatParamSchema = z.object({
  id: z.string().min(1, 'Knowledge Base ID is required'),
  chatId: z.string().min(1, 'Chat ID is required'),
})

/** @description Validates knowledge base ID and search ID path parameters */
export const searchParamSchema = z.object({
  id: z.string().min(1, 'Knowledge Base ID is required'),
  searchId: z.string().min(1, 'Search ID is required'),
})

/** @description Validates knowledge base ID and sync config ID path parameters */
export const syncConfigParamSchema = z.object({
  id: z.string().min(1, 'Knowledge Base ID is required'),
  configId: z.string().min(1, 'Config ID is required'),
})

/** @description Validates knowledge base ID and entity permission ID path parameters */
...
/** @description Validates POST /api/knowledge-base request body for knowledge base creation */
...
/** @description Validates PUT /api/knowledge-base/:id request body for knowledge base updates */
...
/** @description Validates POST /api/knowledge-base/:id/permissions body for permission upsert */
...
// ---------------------------------------------------------------------------
// Knowledge Base Datasets schemas
// ---------------------------------------------------------------------------

/** @description Validates POST /api/knowledge-base/:id/datasets body for dataset linking */
...
/** @description Validates POST /api/knowledge-base/:id/categories body for category creation */
...
/** @description Validates PUT /api/knowledge-base/:id/categories/:catId body for category updates */
...
/** @description Validates POST /api/knowledge-base/:id/chats body for chat creation */
...
/** @description Validates PUT /api/knowledge-base/:id/chats/:chatId body for chat updates */
...
/** @description Validates POST /api/knowledge-base/:id/searches body for search creation */
...
/** @description Validates PUT /api/knowledge-base/:id/searches/:searchId body for search updates */
...
/** @description Validates POST /api/knowledge-base/:id/sync-configs body for sync config creation */
...
/** @description Validates POST /api/knowledge-base/:id/members body for adding a knowledge base member */
export const addMemberSchema = z.object({
  user_id: hexIdWith('Invalid user UUID'),
})

/** @description Validates knowledge base ID and user ID path parameters for member removal */
...
/** @description Validates POST /api/knowledge-base/:id/datasets/bind body for batch dataset binding */
...
/** @description Validates GET /api/knowledge-base/:id/activity query params for pagination */
