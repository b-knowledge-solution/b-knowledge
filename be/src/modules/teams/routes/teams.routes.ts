...
router.post('/', requirePermission('manage_users'), validate(createTeamSchema), controller.createTeam.bind(controller))
 ...
 */
// Update team details
router.put('/:id', requirePermission('manage_users'), validate({ params: uuidParamSchema, body: updateTeamSchema }), controller.updateTeam.bind(controller))
...
router.delete('/:id', requirePermission('manage_users'), validate({ params: uuidParamSchema }), controller.deleteTeam.bind(controller))
...
router.post('/:id/members', requirePermission('manage_users'), validate({ params: uuidParamSchema, body: addMembersSchema }), controller.addMembers.bind(controller))
...
router.delete('/:id/members/:userId', requirePermission('manage_users'), validate({ params: memberParamSchema }), controller.removeMember.bind(controller))
...
router.post('/:id/permissions', requirePermission('manage_users'), validate({ params: uuidParamSchema, body: grantPermissionsSchema }), controller.grantPermissions.bind(controller))
