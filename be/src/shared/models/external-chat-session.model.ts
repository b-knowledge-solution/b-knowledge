/**
 * @fileoverview External Chat Session Model.
 *
 ...
 *
 * @module shared/models/external-chat-session
 */
...
/**
 * External chat session record shape.
...
/**
 * ExternalChatSessionModel
 * Provides CRUD operations for the history_chat_sessions table.
 * @description Manages external chat session records with user history queries.
 */
