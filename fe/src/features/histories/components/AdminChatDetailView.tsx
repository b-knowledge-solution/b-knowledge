/**
 * @fileoverview Admin chat detail view component.
 * Displays sticky header with session ID, user messages, AI responses, and citations.
 *
...
/**
 * Admin chat detail view showing session ID and conversation messages.
 * @param props - Component props.
 * @returns Rendered admin chat detail view.
 */
export const AdminChatDetailView = ({
    session,
    details,
    isLoadingDetails,
    searchQuery,
                    ...
                    <div className="flex items-center gap-4 mb-2">
                        ...
                        <div>
                            <h2 className="text-lg font-bold text-slate-900 dark:text-white leading-tight">
                                {t('histories.conversationHistory', 'Conversation History')}
                            </h2>
