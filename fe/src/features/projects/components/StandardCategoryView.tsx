 ...
 *
 * @module features/projects/components/StandardCategoryView
 */
...
import type { DocumentCategory } from '../api/projectApi'
 ...
 */
const StandardCategoryView = ({ projectId, category }: StandardCategoryViewProps) => {
