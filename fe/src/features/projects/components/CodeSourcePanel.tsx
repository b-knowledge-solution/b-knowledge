 ...
 * @module features/projects/components/CodeSourcePanel
 */
 ...
 */
export default function CodeSourcePanel({ projectId, categoryId, datasetId: _datasetId, onImportComplete }: CodeSourcePanelProps) {
  ...
  const handleGitImport = async () => {
    ...
    try {
      setImporting(true)
      const result = await importGitRepo(projectId, categoryId, {
        url: gitUrl.trim(),
  ...
  const handleZipImport = async () => {
    ...
    try {
      setImporting(true)
      const result = await importZipFile(projectId, categoryId, zipFile)
      globalMessage.success(t('projects.codeSourceImportSuccess', { count: result.fileCount }))
