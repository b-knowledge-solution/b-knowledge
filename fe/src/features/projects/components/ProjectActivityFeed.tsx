/**
 * @fileoverview Paginated activity feed for a project.
 * Displays audit log entries with action icons, descriptions, and relative timestamps.
 * @module features/projects/components/ProjectActivityFeed
 */
...
import { useProjectActivity } from '../api/projectQueries'
import type { ActivityEntry } from '../api/projectApi'
...
interface ProjectActivityFeedProps {
  /** Project UUID to show activity for */
  projectId: string
}
 ...
 * @param {ProjectActivityFeedProps} props - Component props
...
export default function ProjectActivityFeed({ projectId }: ProjectActivityFeedProps) {
  ...
  const { data, isLoading } = useProjectActivity(projectId, PAGE_SIZE, offset)
