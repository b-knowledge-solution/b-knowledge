/**
 * @fileoverview Project member list with add/remove functionality.
 * Displays a table of project members with role badges and removal actions.
 * @module features/projects/components/ProjectMemberList
 */
...
import { useProjectMembers, useAddMember, useRemoveMember } from '../api/projectQueries'
...
interface ProjectMemberListProps {
  /** Project UUID to manage members for */
  projectId: string
}
 ...
 * @param {ProjectMemberListProps} props - Component props
