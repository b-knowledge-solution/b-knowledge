 ...
 *
 * @module features/projects/components/DocumentsTabRedesigned
 */
 ...
 */
const DocumentsTabRedesigned = ({ projectId, initialCategories, embeddingModels }: DocumentsTabRedesignedProps) => {
