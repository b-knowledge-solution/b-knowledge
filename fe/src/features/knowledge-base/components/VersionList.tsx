 ...
 *
 * @module features/knowledge-base/components/VersionList
 */
...
const VersionList = ({
  ...
  const handleCreateVersion = async (formData: VersionFormData) => {
    ...
    try {
      ...
      await createCategoryVersion(knowledgeBaseId, categoryId, payload)
  ...
  const handleDeleteVersion = async (versionId: string) => {
    ...
    try {
      await deleteCategoryVersion(knowledgeBaseId, categoryId, versionId)
  ...
  const handleArchiveVersion = async (versionId: string) => {
    try {
      await archiveCategoryVersion(knowledgeBaseId, categoryId, versionId)
