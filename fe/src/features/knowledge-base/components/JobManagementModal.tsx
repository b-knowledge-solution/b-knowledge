 ...
 *
 * @module features/knowledge-base/components/JobManagementModal
 */
...
const JobManagementModal = ({
  ...
  }, [open, knowledgeBaseId, categoryId, versionId])
  ...
  const triggerParseAll = async (latestJobs: VersionJob[]) => {
    ...
    try {
      ...
      const result = await parseVersionDocuments(knowledgeBaseId, categoryId, versionId, fileNames)
