 ...
 *
 * @module features/knowledge-base/components/StandardTabRedesigned
 */
 ...
 */
const StandardTabRedesigned = ({ knowledgeBaseId, initialCategories, embeddingModels }: StandardTabRedesignedProps) => {
  ...
  const handleCreateCategory = async (data: { name: string; dataset_config: Record<string, any> }) => {
    try {
      ...
      await createDocumentCategory(knowledgeBaseId, { ...data, category_type: 'standard' })
