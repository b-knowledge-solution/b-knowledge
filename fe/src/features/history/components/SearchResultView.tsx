/**
 * @fileoverview Search result detail view component.
 * Displays sticky header, search queries, AI summaries, and file results.
 *
 * @module features/history/components/SearchResultView
 */
...
import type { SearchSessionSummary, ExternalSearchHistory } from '../api/historyService'
import { HighlightMatch } from './HighlightMatch'

/**
 * Props for the SearchResultView component.
 */
interface SearchResultViewProps {
    /** The selected session summary. */
    session: SearchSessionSummary
    /** Detailed search records for the session. */
    details: ExternalSearchHistory[] | undefined
...
/**
 * Main content area displaying search results with AI summaries.
 * @param props - Component props.
 * @returns Rendered search result detail view.
 */
