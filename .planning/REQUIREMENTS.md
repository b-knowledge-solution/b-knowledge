...
- [x] **PRSR-02**: API documentation parser — parse OpenAPI/Swagger specs into structured endpoint chunks
- [x] **PRSR-03**: Technical decision record (ADR) parser — template-aware parsing of context/decision/consequences
