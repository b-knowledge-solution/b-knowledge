...
- [x] 11-02-PLAN.md -- Backend startup auto-seed hook for system provider
- [x] 11-03-PLAN.md -- Valkey Stream bridge (Python worker + Node.js service)
- [x] 11-04-PLAN.md -- Frontend: system badge + re-embed warning banner + i18n
...
| 11. Internal Embedding System | v0.2 | 4/5 | In Progress|  |
