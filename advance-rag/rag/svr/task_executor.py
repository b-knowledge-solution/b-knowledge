...
async def run_raptor_for_kb(row, kb_parser_config, chat_mdl, embd_mdl, vector_size, callback=None, doc_ids=[]):
    ...
    # Build cross-KB document name lookup to prevent name collisions
    # when multiple documents share a knowledge base
    doc_name_by_id = {}
    ...
    async def generate(chunks, did):
        ...
        # Use actual document name when available to avoid cross-KB naming collisions
