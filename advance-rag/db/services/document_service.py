...
from db import PIPELINE_SPECIAL_PROGRESS_FREEZE_TASK_TYPES, FileType, UserTenantRole, CanvasCategory
...
class DocumentService(CommonService):
    ...
    def remove_document(cls, doc, tenant_id):
        from db.services.task_service import TaskService, cancel_all_task_of
    ...
    def run(cls, tenant_id:str, doc:dict, kb_table_num_map:dict):
        from db.services.task_service import queue_dataflow, queue_tasks
